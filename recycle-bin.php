...
<head>
    ...
    <title>Recycle bin - LaTeX-pro</title>
...
<body>
    ...
    <div id="content">
        <div class="nav">
            ...
            <div class="nav-categories active"><a href="recycle-bin.php">Recycle bin</a></div>
        </div>
        <div class="index">
            <h2>Your recycled projects</h2>
            <?php
            require_once("config/database.php");
            $sql = "SELECT id_project, project_name, creation_date, last_opened, last_saved FROM PROJECT WHERE id_user_owner = " . $_SESSION['id'] . " AND trashed = 1";
            ...
            <table class="existing-projects">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="php-scripts/delete_project.php?id_project=<?php echo $rows['id_project']; ?>&target=del"><i class="bx bx-trash" alt="Delete permanently" title="Delete permanently"></i></a> <a href="php-scripts/delete_project.php?id_project=<?php echo $rows['id_project']; ?>&target=index"><i class="bx bx-redo" alt="Restore the project" title="Restore the project"></i></a> </td>
                        <!-- <td><form action="php-scripts/delete_project.php" action="POST"><input type="submit" value="Delete the project" name="<?php // echo $rows['id_project']; ?>"></input></form></td> -->
                    </tr>
                <?php
                }
                ?>
