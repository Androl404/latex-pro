...
<head>
    ...
    <title>End User Licence Agreement (EULA) - LaTeX-pro</title>
...
<body>
    ...
    <div id="content-doc">
        <div>
            ...
            <p><span class="bold">Last Updated:</span> Saturday 20<sup>th</sup> of July 2024, 04:02 PM</p>
            <h1>End User License Agreement of <span class="latex-pro"><span class="latex">L<sup>a</sup>T<sub>e</sub>X</span>-pro</span></h1>
            ...
            <p>Andrei D. Zeucianu, at 14 chemin Claude Berthier, 42100 Saint-Étienne, France</p>
            <p><strong>Contact email:</strong> <a href="mailto:andrei.zeucianu@etu.univ-st-etienne.fr" class="mail">andrei.zeucianu@etu.univ-st-etienne.fr</a></p>
            ...
            <ul>
                <li>you are older than 13 years old;</li>
            ...
            <p>To use our application, you can register or create an account by providing complete and truthful information. You cannot benefit of our service without an account, in order for us to be able to monitor all the activity on our service.</p> <!-- You can also use our application without an account, but this might limit some features. -->
            ...
            <p>Any contact tentative shall be made with the form we are make available right <a href="../contact.php">here</a>.</p>
            ...
            <p>You can close your account and stop using our service anytime by contacting us with the contatc form we are making available for you right <a href="../contact.php">here</a>.</p>
            ...
            <p>Despite the above, under this license, you can use, and run in your Web browser the software on as much devices you want, as long as your devices are common and up-to-date with current technology and market standards, and as long as you use your account to log-in and use our software.</p>
            <p>We reserve the right to release updates and improvements to our application and its related software. You may need to reload the software we are providing, in order to keep the cache files in your borwser up-to-date so you can benefit of the latest functionnality available.</p>
            <p>However, in order to get access to completely new versions or releases of the software you might need to purchase a separate license.</p>
            <p>Notwithstanding the foregoing, you undertake to immediately delete any datas on the software upon the expiry of the license.</p>
            <p>The software licensed will be valid and functional while our software is provided on the Internet since it has been made available to you, and in any case for the entire duration of the subscription, subject to the conditions of the agreement including, without limitation, any required updates. It is understood that the possible occurrence of errors and occasional technical faults is inherent to the nature of software. To the extent required under applicable law and/or the agreement, we commit to resolving possible defects and/or faults impairing the software’s functionality during the validity period, unless these result from any improper or irregular use of the software, including (without limitation) your failure to implement any required updates.</p>
            ...
            <h4>Subscriptions</h4>
            <p>Subscriptions allow you to benefits of multiple premium functionnalities.</p>
            <p>At this moment, our software is completely free, and no subcriptions are available to the purchase.</p>
            ...
            <p>Subscriptions may be terminated by us, or by you at any moment. You can choose yo terminate your subscription by contact us with the contact form right <a href="../contact.php">here</a>. Your subcription ill be then terminated once we take acknowledge of your request. In the case we want to terminate your subscription, we will send you a notice on the email account you provided us, and which can be changed at any time in your <a href="../dashboard.php">dashboard</a>.</p>
